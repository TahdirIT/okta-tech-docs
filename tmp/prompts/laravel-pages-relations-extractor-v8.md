...
File naming rule:
<folder>.<folder>...<from-page>.yaml

Examples:
generated/page-relations/auth.user-login.yaml
generated/page-relations/dashboard.home.yaml
generated/page-relations/settings.countries.index.yaml
...
from: <page-name>
description: <short description of the page (max 50 words)>
relations:
  - to: <target-page>
...
If the page belongs to folders/modules, prefix using dot notation:
<folder>.<subfolder>.<page>

Examples:
UserLoginController -> auth.user-login  
/dashboard -> dashboard.home  
/settings/countries -> settings.countries.index  

# =========================
# DESCRIPTION RULE
# =========================

- Add a concise description for each "from" page.
- Maximum 50 words.
- Focus on purpose of the page (what user does there).
- Avoid technical implementation details.

Examples:
description: User login page where users enter credentials to access the system.
description: Dashboard overview showing key statistics and quick navigation to main modules.
...
File: generated/page-relations/auth.user-login.yaml

from: auth.user-login
description: User login page where users enter credentials to authenticate and access their account dashboard.
relations:
  - to: dashboard.home
    relation: navigation
