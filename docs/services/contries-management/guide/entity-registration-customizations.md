...
- **إلزام اسم المستخدم**: تحديد ما إذا كان إدخال اسم المستخدم إجباريًا أثناء التسجيل.
- **إلزام رقم الهوية الوطنية**: تحديد ما إذا كان إدخال رقم الهوية إجباريًا.

> ملاحظة: يمكن السماح بأن يكون أي منها إلزاميًا أو اختياريًا حسب سياسة الدولة.

### 1.1) تحقق بيانات التواصل (Contact Validations)

بالإضافة إلى الإلزامية، يمكن تعريف قواعد تحقق (Regex) على حقلي الجوال ورقم الهوية:

- **قواعد التحقق من رقم الجوال**: قواعد Regex مع رسائل خطأ ثنائية اللغة
- **قواعد التحقق من رقم الهوية**: قواعد Regex مع رسائل خطأ ثنائية اللغة

مثال على قاعدة للجوال السعودي: نمط يتحقق من أن الرقم يبدأ بـ `05` ومكوّن من 10 أرقام.
