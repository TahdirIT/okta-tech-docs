...
هذا المجلد يحتوي على توثيق نماذج البيانات المستخدمة في خدمة **إدارة الدول**.
...
- [Academic Years](./academic_years.md)
- [Terms](./terms.md)
- [Education Level Groups](./education_level_groups.md)
- [Education Levels](./education_levels.md)
- [Education Level Group Levels](./education_level_group_levels.md)
